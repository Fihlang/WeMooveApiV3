        ...
        <div className="flex flex-col md:flex-row justify-between mb-8">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center mb-4">
              ...
              <h3 className="font-heading font-bold text-xl">CultureQuest</h3>
            </div>
            <p className="text-gray-400 max-w-xs">Discover the world's cultures through fun, interactive puzzles and games.</p>
          </div>
